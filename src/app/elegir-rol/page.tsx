  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center gap-3 px-6 py-12">
      <div className="mb-4">
        ...
        <p className="mt-2 text-[14px] leading-snug text-ink-500">
      ...
      {OPCIONES.map((opcion) => (
        ...
        >
          <div className="flex-1">
            <h2 className="text-[15px] font-semibold text-ink-900">{opcion.titulo}</h2>
            <p className="mt-1 text-[13px] leading-snug text-ink-500">{opcion.detalle}</p>
          </div>
          <Icono
